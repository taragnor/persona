...
import {BOOLEAN_COMPARISON_TARGET, COMBAT_COMPARISON_SUBLIST, NONDEPBOOLEAN_COMPARISON_TARGET, POWER_COMPARISON_SUBLIST, ROLL_COMPARISON_SUBLIST, SOCIAL_CHECKS, SPECIAL_BOOLEAN_SUBLIST, TAG_COMPARISON_TYPES} from "./boolean-comparison.js";
