...
import {BOOLEAN_COMPARISON_TARGET, COMBAT_COMPARISON_SUBLIST, ITEM_CHECK_TYPE, NONDEPBOOLEAN_COMPARISON_TARGET, POWER_COMPARISON_SUBLIST, ROLL_COMPARISON_SUBLIST, SOCIAL_CHECKS, SPECIAL_BOOLEAN_SUBLIST, TAG_COMPARISON_TYPES} from "./boolean-comparison.js";
...
import {CREATURE_TAGS, SHADOW_TAGS} from "./creature-tags.js";
import {DAMAGE_LEVELS, DAMAGE_TYPES_PLUS_AFFINITY, DAMAGETYPES, REALDAMAGETYPES, RESIST_STRENGTHS} from "./damage-types.js";
import {DAYS_LIST} from "./days.js";
import {ALTER_MP_SUBTYPES, ANIMATION_ACTION, ANIMATION_OFFSET, COMBAT_EFFECTS, CONSQUENCETYPES, DAMAGE_SUBTYPES, DUNGEON_ACTIONS, EVENT_CHAIN_ACTIONS, INVENTORY_ACTION, MODIFIER_CONS_TYPES, MODIFIER_VARIABLES, NONDEP_CONSQUENCETYPES, POWERTYPES, PROJECTILE_OPTIONS, SFX_CONSEQUENCE, SHADOW_CHARGE_REQ, SOCIAL_CARD_ACTIONS, TARGETING, TRIGGER_EVENT_CONS} from "./effect-types.js";
...
private static _powerStuffBase: Record<string, unknown>;
	...
	static powerStuff(): Record<string, unknown> {
		...
		const UNIFIED_PERSONA_TAGS = PersonaDB.createMergedTagLocList(["persona"], SHADOW_TAGS);
    ...
    const data = {
      ...
      PERSONA_TAGS: UNIFIED_PERSONA_TAGS,
