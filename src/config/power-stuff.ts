...
import {ALTER_MP_SUBTYPES, COMBAT_EFFECTS, CONSQUENCETYPES, DAMAGE_SUBTYPES, DUNGEON_ACTIONS, INVENTORY_ACTION, MODIFIER_CONS_TYPES, MODIFIER_VARIABLES, NONDEP_CONSQUENCETYPES, POWERTYPES, SHADOW_CHARGE_REQ, SOCIAL_CARD_ACTIONS, TARGETING} from "./effect-types.js";
