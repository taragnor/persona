...
import {BOOLEAN_COMPARISON_TARGET, NONDEPBOOLEAN_COMPARISON_TARGET, POWER_COMPARISON_SUBLIST, ROLL_COMPARISON_SUBLIST, SOCIAL_CHECKS, TAG_COMPARISON_TYPES} from "./boolean-comparison.js";
...
import {ALTER_MP_SUBTYPES, COMBAT_EFFECTS, CONSQUENCETYPES, DAMAGE_SUBTYPES, DUNGEON_ACTIONS, MODIFIER_CONS_TYPES, MODIFIER_VARIABLES, NONDEP_CONSQUENCETYPES, POWERTYPES, SHADOW_CHARGE_REQ, SOCIAL_CARD_ACTIONS, TARGETING} from "./effect-types.js";
