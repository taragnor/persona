...
export class ConditionalEffectManager {
  ...
  static #getPaths(ev: JQuery.Event) {
  ...
  static #getEffectIndex(ev: JQuery.Event) {
  ...
  static applyHandlers<D extends FoundryDocument<any>>(html: JQuery, doc: D, contextMenu ?: ContextMenu) {
