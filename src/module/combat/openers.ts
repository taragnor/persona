...
export class OpenerManager {
  ...
  constructor(combat: PersonaCombat) {
    this.combat = combat;
    this.openerSaves = new OpenerSaves(combat);
  }
  ...
  generateSituation(combatant: PersonaCombatant, rollValue: number) : N<SituationComponent.Roll> {
...
export type OpenerOptionsGroups = {
  msg: string[],
