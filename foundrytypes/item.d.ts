...
type ItemFullType<T extends SchemaDict = any, ActorType extends Actor<any, any, any> = Actor<any,any,any>, AEType extends ActiveEffect<ActorType, any> = ActiveEffect<ActorType, any>> = Item<T, ItemType, AEType>
	...
	interface Item<T extends SchemaDict = any, ActorType extends Actor<any, this, any> = Actor<any,this,any>, AEType extends ActiveEffect<ActorType, this> = ActiveEffect<ActorType, this>> extends Document<ItemType | AEType>{
